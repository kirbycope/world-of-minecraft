...
setblock 3704 91 8888 spawner{SpawnData:{entity:{id:"wolf",CustomName:'"Blackrock Worg"'}},MaxNearbyEntities:4,Delay:60,RequiredPlayerRange:16} replace
setblock 3704 92 8888 moss_carpet replace
# Blackrock Worg spawner 2
setblock 3704 89 8868 spawner{SpawnData:{entity:{id:"wolf",CustomName:'"Blackrock Worg"'}},MaxNearbyEntities:4,Delay:60,RequiredPlayerRange:16} replace
setblock 3704 90 8868 moss_carpet replace
# Blackrock Worg spawner 3
setblock 3691 90 8851 spawner{SpawnData:{entity:{id:"wolf",CustomName:'"Blackrock Worg"'}},MaxNearbyEntities:4,Delay:60,RequiredPlayerRange:16} replace
setblock 3691 91 8851 moss_carpet replace

# Blackrock Orc spawner 1
setblock 3664 93 8830 spawner{SpawnData:{entity:{id:"pillager",CustomName:'"Blackrock Orc"'}},MaxNearbyEntities:4,Delay:60,RequiredPlayerRange:16} replace
setblock 3664 94 8830 moss_carpet replace
# Blackrock Orc spawner 2
setblock 3365 94 8788 spawner{SpawnData:{entity:{id:"pillager",CustomName:'"Blackrock Orc"'}},MaxNearbyEntities:4,Delay:60,RequiredPlayerRange:16} replace
