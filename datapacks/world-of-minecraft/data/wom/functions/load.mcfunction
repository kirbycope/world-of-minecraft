...
setblock 3704 91 8888 spawner{SpawnData:{entity:{id:"wolf",CustomName:'"Blackrock Worg"'}},MaxNearbyEntities:4,Delay:60,RequiredPlayerRange:24} replace
setblock 3704 92 8888 moss_carpet replace
# Blackrock Worg spawner 2
setblock 3704 89 8868 spawner{SpawnData:{entity:{id:"wolf",CustomName:'"Blackrock Worg"'}},MaxNearbyEntities:4,Delay:60,RequiredPlayerRange:24} replace
setblock 3704 90 8868 moss_carpet replace
# Blackrock Worg spawner 3
setblock 3691 90 8851 spawner{SpawnData:{entity:{id:"wolf",CustomName:'"Blackrock Worg"'}},MaxNearbyEntities:4,Delay:60,RequiredPlayerRange:24} replace
